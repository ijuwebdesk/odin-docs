...
description: How Odin's blue triangle pointer works.
sidebar:
  order: 3
---
...
2. **Pixel coordinates** — a fallback for content inside web pages or other areas not covered by the accessibility list. Odin estimates the position from the screenshot dimensions.
