---
title: Quick Start
description: Get up and running with Silk in under two minutes.
sidebar:
  order: 4
---
...
1. **Install Silk** and launch it. The Silk icon appears in your menu bar or system tray.

2. **Grant permissions** when the onboarding screen appears — Microphone and Screen Recording (macOS).

3. **Open the panel** by clicking the Silk icon in your menu bar.

4. **Press `Ctrl+Space`** to start listening, speak your question, then **press `Ctrl+Space` again** to stop. (It's a toggle, not a hold.)

5. **Silk responds** — spoken aloud, with a small blue triangle on screen pointing at anything relevant.
...
<Aside type="tip">
Silk's responses are tuned for listening, not reading — short, direct, no bullet points. If you want more detail, just say "go deeper" or "explain more."
</Aside>
